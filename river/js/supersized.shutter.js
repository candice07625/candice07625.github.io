...
(function($){
		...
		----------------------------*/
	 	_init : function(){
    		...
    		if (api.options.autoplay){
				...
				if ($(vars.play_button).attr('class', 'icon-pause')) {
					$(vars.play_button).attr('class', 'icon-play');	// If pause play button is image, swap src
				}
	...
	*/		
		...
		----------------------------*/
	 	playToggle : function(state){
	 		...
	 		if (state =='play'){
	 			...
	 			if ($(vars.play_button).attr('class', 'icon-play-sign')) {
					$(vars.play_button).attr('class', 'icon-stop');	// If pause play button is image, swap src
				}
				if (api.options.progress_bar && !vars.is_paused) theme.progressBar();
	 		}else if (state == 'pause'){
	 			// If image, swap to play
	 			if ($(vars.play_button).attr('class', 'icon-stop')) {
					$(vars.play_button).attr('class', 'icon-play');	// If pause play button is image, swap src
				}
		...
		// titles animation
			...
			$('#slidecaption').show('fast', function() {
		  	/* Update Fields
		  	----------------------------*/
